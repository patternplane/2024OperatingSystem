...
public class S_SCAN implements DiskScheduler {
	private final int INIT_HEAD_POSITION;
	private int headPos;
	private HeadDirection headDirection;

	public S_SCAN(int InitHeadPosition, HeadDirection InitHeadDirection) {
